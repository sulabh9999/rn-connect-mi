...
import static com.example.myapplication.common.UUIDs.AUTH_CHAR_KEY;
import static com.example.myapplication.common.UUIDs.CHAR_AUTH;
import static com.example.myapplication.common.UUIDs.CHAR_BATTERY;
...
import static com.example.myapplication.common.UUIDs.NOTIFICATION_DESC;
import static com.example.myapplication.common.UUIDs.SERVICE1;
import static com.example.myapplication.common.UUIDs.SERVICE2;
...
import com.example.myapplication.info.InfoReceiver;
...
public class GattCallback extends BluetoothGattCallback {
    ...
    public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
        switch (newState) {
            case BluetoothGatt.STATE_DISCONNECTED:
                Log.i("Ranu BLE", "Device disconnected");
                break;
    ...
    public void onCharacteristicWrite(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status){
        switch (characteristic.getUuid().toString()) {
            ...
            default:
                Log.i("Ranu BLE", "onCharacteristicWrite uuid: " + characteristic.getUuid().toString()
                        + " value: " + Arrays.toString(characteristic.getValue()) + " status: " + status);
        }
    }
            ...
            case CHAR_HEART_RATE_MEASURE:{
                switch (Arrays.toString(descriptor.getValue())){
                    case "[1, 0]":{
                        ...
                        Log.i("Ranu BLE","hrCtrlChar: " + gatt.writeCharacteristic(hrCtrlChar));
                    }
                    default:
                        Log.i("Ranu BLE", "onDescriptorWrite uuid: " + descriptor.getUuid().toString()
